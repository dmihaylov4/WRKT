...
struct PlateTier: Identifiable {
    ...
    static let all: [PlateTier] = [
        ...
        PlateTier(id: 23, name: "Navy Bumper", rarity: .rare,
                  ...
                  metallic: 0, roughness: 0.76, clearcoat: 0.28, clearcoatRoughness: 0.34,
                  style: .bumper),
        PlateTier(id: 24, name: "Heat Forge", rarity: .epic,
                  earnedBy: "HIIT/Functional challenge completion",
                  plateColor: UIColor(red: 0.04, green: 0.04, blue: 0.04, alpha: 1),
                  metallic: 0, roughness: 0.54, clearcoat: 0.62, clearcoatRoughness: 0.18,
                  style: .bumper),
        PlateTier(id: 25, name: "Iron Circuit", rarity: .rare,
                  earnedBy: "Volume Battle participation",
                  plateColor: UIColor(red: 0.18, green: 0.19, blue: 0.20, alpha: 1),
                  metallic: 0.14, roughness: 0.78, clearcoat: 0.16, clearcoatRoughness: 0.44,
                  style: .castIron),
        PlateTier(id: 26, name: "Dark Chrome", rarity: .epic,
                  earnedBy: "Volume Battle winner",
                  plateColor: UIColor(red: 0.10, green: 0.10, blue: 0.11, alpha: 1),
                  metallic: 1.0, roughness: 0.035, clearcoat: 0.82, clearcoatRoughness: 0.018,
                  style: .polishedSteel),
        PlateTier(id: 27, name: "Iron Mark", rarity: .rare,
                  earnedBy: "Exercise Battle participation",
                  plateColor: UIColor(red: 0.22, green: 0.22, blue: 0.24, alpha: 1),
                  metallic: 0.14, roughness: 0.75, clearcoat: 0.16, clearcoatRoughness: 0.44,
                  style: .castIron),
        PlateTier(id: 28, name: "Iron Crown", rarity: .epic,
                  earnedBy: "Exercise Battle winner",
                  plateColor: UIColor(red: 0.30, green: 0.24, blue: 0.10, alpha: 1),
                  metallic: 0.96, roughness: 0.075, clearcoat: 0.78, clearcoatRoughness: 0.035,
                  style: .brass),
        PlateTier(id: 29, name: "Carbon Sprint", rarity: .rare,
                  earnedBy: "Distance Duel participation",
                  plateColor: UIColor(red: 0.03, green: 0.03, blue: 0.04, alpha: 1),
                  metallic: 0, roughness: 0.54, clearcoat: 0.62, clearcoatRoughness: 0.18,
                  style: .bumper),
        PlateTier(id: 30, name: "Carbon Elite", rarity: .epic,
                  earnedBy: "Distance Duel winner",
                  plateColor: UIColor(red: 0.04, green: 0.18, blue: 0.52, alpha: 1),
                  metallic: 0, roughness: 0.44, clearcoat: 0.76, clearcoatRoughness: 0.12,
                  style: .competition),
        PlateTier(id: 31, name: "Forge S1", rarity: .legendary,
                  earnedBy: "Season 1 completion",
                  plateColor: UIColor(red: 0.98, green: 0.72, blue: 0.16, alpha: 1),
...
struct BarSkin: Identifiable {
    ...
    static let all: [BarSkin] = [
        ...
        BarSkin(id: 4, name: "VOLIA", rarity: .epic,
                earnedBy: "Complete any workout challenge",
                barColor: UIColor(red: 0.80, green: 1.00, blue: 0.00, alpha: 1),
    ...
    static let current = BarbellCosmeticCatalog(
        ...
        items: [
            ...
            BarbellCosmetic(
                ...
                name: "VOLIA",
                rarity: .epic,
                unlockRequirement: "Complete any workout challenge",
                isDefault: false
            ),
            BarbellCosmetic(
                id: "dark_gym",
