...
actor Persistence {
    ...
    private nonisolated let currentWorkoutURL: URL
    private init() {
    ...
    nonisolated func loadCurrentWorkout() async -> CurrentWorkout? {
    ...
    nonisolated func saveCurrentWorkout(_ current: CurrentWorkout?) async {
